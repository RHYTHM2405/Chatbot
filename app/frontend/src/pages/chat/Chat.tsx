...
import { SparkleFilleddd} from "@fluentui/react-icons";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Chat with AssessfyBot</h1>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What is assessfy and how does it help companies in recruitment process?)"
                            disabled={isLoading}
